<section>
    ...
    <form method="post" action="{{ route('work.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        @csrf
        @method('post')
        ...
        <div>
            ...
            <x-text-input id="program" name="program" type="text" class="mt-1 block w-full" :value="old('program')" />
